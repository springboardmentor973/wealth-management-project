  ...
  return (
    <div className="p-6 bg-gray-100 min-h-screen">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
        ...
        {/* --- GOALS SUMMARY CARD (Your Task) --- */}
        <div className="bg-white p-6 rounded-xl shadow-md border-l-4 border-blue-500">
          <h2 className="text-xl font-semibold text-gray-700 mb-4">Goals Summary</h2>
          
          {/* Dummy Goal 1 */}
          <div className="mb-4">
            <div className="flex justify-between mb-1">
              <span className="text-sm font-medium text-gray-700">Buy New Laptop</span>
        ...
        {/* Placeholder for other cards (Portfolio, Profile) */}
        <div className="bg-white p-6 rounded-xl shadow-md border-t-4 border-purple-500">
          <h2 className="text-xl font-semibold text-gray-700 mb-2">Portfolio Value</h2>
